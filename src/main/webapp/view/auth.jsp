...
<div class="container " id="login">
    <form  id="form1" class="form" method="post"  action="/auth" id="login-form">
        <h2>Login</h2>
...
<div class="container hide" id ="signup" >
    <form id="form2" class="form" action="/user" method="post" enctype="multipart/form-data" id="signup-form">
        <h2>Sign Up</h2>
        ...
        <input  required type="file" id="image" name="file">
