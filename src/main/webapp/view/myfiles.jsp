<%@ page import="com.cloud.model.entity.File" %>
...
<main class="main-content" id="body">
    ...
    <div class="elements">
        <%
            List<File> files= (List<File>) request.getAttribute("userFiles");


            for (File ele : files) {
                String dt = ele.getType().toString();
        %>
        <div class="entity" id="<%=ele.getFid()%>">
            <%-- <div class="content-">
                <%
            ...
            <div class="content-action">
                <a href="download?fileid=<%=ele.getUser().getId()%>">
                    <button>Download</button>
                </a>
                <button onclick="delet('<%=ele.getFid()%>')"
                        style="background: red">Delete</button>
                <button onclick="openShareList('<%=ele.getFid()%>')"
